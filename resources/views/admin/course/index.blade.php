...
@section('body')
    ...
    <div class="relative md:ml-72 bg-blueGray-50">
        ...
        <div class="my-10 w-full min-h-screen px-4 mx-auto md:px-10 -m-36">
            <div
                class="relative flex flex-col w-full min-w-0 mb-6 break-words bg-white rounded shadow-lg text-gray-600 dark:text-white         bg-white dark:bg-[#303150]">
                            ...
                            <div class="p-5 space-y-6 ">
                                <table class="items-center w-full bg-transparent border-collapse ">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            <th scope="col"
                                                class="px-3 py-3 text-xs font-semibold text-left uppercase align-middle border border-l-0 border-r-0 border-solid whitespace-nowrap bg-blueGray-50 text-gray-600 dark:text-whiteborder-blueGray-100">
                                                ID Voucher
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-3 text-xs font-semibold text-left uppercase align-middle border border-l-0 border-r-0 border-solid whitespace-nowrap bg-blueGray-50 text-gray-600 dark:text-whiteborder-blueGray-100">
                                            ...
                                            <th scope="col"
                                                class="px-3 py-3 text-xs font-semibold text-left uppercase align-middle border border-l-0 border-r-0 border-solid whitespace-nowrap bg-blueGray-50 text-gray-600 dark:text-white border-blueGray-100">
                                                Action
                                            </th>
                ...
                {{-- end modal --}}
                <div class="block w-full overflow-x-auto px-5 bg-white dark:bg-[#303150]">
