...
@section('body')
    ...
    <div class="relative md:ml-72 bg-blueGray-50">
        ...
        <div class="my-10 px-4 md:px-10 mx-auto w-full -m-36 min-h-screen">
            <div class="flex lg:justify-between sm:flex-col lg:flex-row min-h-screen w-full">
                <div class="lg:w-1/2 mb-12 px-4">
                    <div
                        class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white  rounded bg-white dark:bg-[#303150]">
                        ...
                        <div class="block w-full overflow-x-auto  rounded bg-white dark:bg-[#303150]">
                            <table class="items-center w-full bg-transparent border-collapse ">
                                <thead class=" rounded bg-white dark:bg-[#303150]">
                                    <tr>
                                        <th scope="col"
                ...
                <div class="lg:w-1/2 mb-12 px-4">
                    <div
                        class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded  rounded bg-white dark:bg-[#303150]">
                        <div class="flex flex-wrap items-center py-3">
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                                <h3 class="font-semibold text-base text-blueGray-700">
                                    Permissions Tables
                        ...
                        <div class="block w-full overflow-x-auto">
                            <table class="items-center w-full bg-transparent border-collapse">
                                <thead class="bg-gray-100  dark:bg-[#303150]">
                                    <tr>
                                        <th scope="col"
                                            class="px-6 align-middle border border-solid py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left bg-blueGray-50 text-blueGray-500 border-blueGray-100">
                                            Name
