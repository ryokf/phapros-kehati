...
@section('body')
    ...
    <div class="relative md:ml-72 bg-blueGray-50">
        ...
        {{-- <div class="relative mt-3 pt-12">
        </div> --}}
        <div class="py-10">
            <x-dashboard-header />
        </div>
        <div class="my-10 px-4 md:px-10 mx-auto w-full -m-36 min-h-screen text-gray-600 dark:text-white ">
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white dark:bg-[#303150]">
                ...
                <div class="block w-full overflow-x-auto bg-white dark:bg-[#303150]">
