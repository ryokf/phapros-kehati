                ...
                <form method="POST" action="{{ route('login') }}" class="grid grid-cols-6 gap-6 mt-8">
                    ...
                    <div class="col-span-12">
                        ...
                        <input type="email" id="Email" name="email"
                            class="w-full mt-1 text-sm text-gray-700 dark:text-white bg-white border-gray-200 rounded-md shadow-sm dark:bg-zinc-800" />
                        @error('email')
                    ...
                    <div class="col-span-12">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="togglePassword"
                                class="absolute text-gray-500 transform -translate-y-1/2 top-1/3 right-4 focus:outline-none">
