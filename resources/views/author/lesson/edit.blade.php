                ...
                <div
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0 bg-gray-100">
                        ...
                        <form action="lesson" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="relative mt-6">
                                <label for="floating_outlined"
                                    ...
                                    ID video Youtube <span data-popover-target="popover-default" type="button"
                                        class="mx-1 w-4 h-4 bg-slate-800 inline-flex justify-center rounded-full items-center"><i
                                            class="fa-solid fa-info fa-xs " style="color: #ffffff;"></i></span>

                                    <div data-popover id="popover-default" role="tooltip"
                                        class="absolute z-10 invisible inline-block w-64 text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
                                        <div
                                            class="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg dark:border-gray-600 dark:bg-gray-700">
                                            <h3 class="font-semibold text-gray-900 dark:text-white">Bagaimana cara
                                                mendapatkan id video youtube?</h3>
                                        </div>
                                        <div class="px-3 py-2">
                                            <p>Untuk mendapatkan ID video YouTube, lihatlah URL video YouTube dan cari
                                                bagian yang dimulai setelah
                                                "v=" di dalam URL. Misalnya, jika URL video YouTube Anda adalah "https://www.youtube.com/watch?v=AbCdEfGhIjK",
                                                maka ID videonya adalah "AbCdEfGhIjK".</p>
                                        </div>
                                ...
                                <iframe width="420" height="240"
                                    src="https://youtube.com/embed/{{ $lesson->media_link }}" frameborder="0"></iframe>
                            ...
                            <div class="relative mt-6">
                                <label for="desc-trix"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-[#1B1B36]">isi materi</label>

                                <textarea id="editor" name="text_content">
                                        {{ old('text_content', $lesson->text_content) }}
                                    </textarea>
                            </div>
                            <div class="w-full flex justify-end">
                                <button type="submit"
                                    class="self-end w-32 mt-10 focus:outline-none text-white border border-primary bg-sky-900 hover:bg-neutral-800 focus:ring-4 focus:ring-neutral-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-neutral-700 dark:hover:bg-slate-700 dark:focus:ring-slate-800">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
