<tr>
    ...
    <th
        ...
        <img src="{{ $photo == null ? 'https://ui-avatars.com/api/?name=' . $title . '&background=0D8ABC&color=fff&rounded=true&bold=true' : asset(Storage::url($photo)) }}" class="h-12 w-12 bg-white rounded border object-cover" alt="..." />
