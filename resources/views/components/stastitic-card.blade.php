<div class="w-full lg:w-6/12 xl:w-3/12 px-4 text-white ">
    <div class="shadow rounded-xl ">
        ...
        <div
            class="relative flex flex-col min-w-0 break-words {{ $iconBgColor }} rounded-xl overflow-hidden mb-6 xl:mb-0">
            <div class="flex-auto pt-4">
                ...
                <p
                    class="text-sm text-blueGray-400 mt-4 bg-white bg-opacity-40 rounded-b-xl backdrop-blur-lg p-2">
                    {{-- @if ($arrow)
