...
@section('body')
    @php
        $checkCourse = null; // Initialize $checkCourse to null
    @endphp
    ...
    @endforeach
    @if ($checkCourse == null)
        <section class="w-full mx-auto text-2xl font-bold text-center md:p-28 dark:text-white">Mohon Maaf Kelas Belum
            Tersedia</section>
    @else
