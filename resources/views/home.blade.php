...
">
            ...
            <div class="container mx-auto">
                <div class="sm:flex gap-10 items-center md:justify-center text-white">
                    ...
                    <div class="flex gap-4 items-center md:basis-1/5 md:my-0 my-5">
                        <div
                            class="icon bg-gradient-to-br from-green-300 via-10% to-emerald-600 p-3 rounded-xl dark:bg-zinc-100">
                    ...
                    <div class="flex gap-3 items-center md:basis-1/5 md:my-0 my-5">
                        <div
                            class="icon icon bg-gradient-to-br from-orange-300 via-10% to-amber-600 p-3 rounded-xl dark:bg-zinc-100">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-7 h-7">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex gap-3 items-center md:basis-1/5 md:my-0 my-5">
                        <div
                            class="icon icon bg-gradient-to-br from-sky-300 via-10% to-blue-600 p-3 rounded-xl dark:bg-zinc-100">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-7 h-7">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="flex justify-center items-start">
                <div class="w-full sm:w-10/12 md:w-1/2">
                    ...
                    <ul class="flex flex-col">
                        <li class="bg-white my-2 shadow-md dark:bg-[#303150] rounded-lg" x-data="accordion(1)">
                        ...
                        <li class="bg-white my-2 shadow-md dark:bg-[#303150] rounded-lg" x-data="accordion(2)">
                            <h2 @click="handleClick()"
                                class="flex flex-row justify-between items-center font-medium p-3 cursor-pointer dark:text-white">
                        ...
                        <li class="bg-white my-2 shadow-md dark:bg-[#303150] rounded-lg" x-data="accordion(3)">
                            <h2 @click="handleClick()"
                                class="flex flex-row justify-between items-center font-medium p-3 cursor-pointer dark:text-white">
                                <span>
 ...
 background-position: center;">
        <div class="py-20 md:py-36 bg-black/50 md:px-40 px-10 backdrop-blur-md">
            ...
            <p class="text-center text-white pt-5 max-w-4xl mx-auto">Kami di DNCC mengundang Anda untuk bergabung dalam
                perjalanan inspiratif kami sebagai seorang mentor. Bergabunglah dengan kami untuk menciptakan perbedaan yang
                positif dalam komunitas teknologi. Anda akan menjadi bagian dari upaya kolaboratif untuk membantu mencetak
                generasi berbakat yang siap bersaing di dunia teknologi yang terus berkembang.
            </p>
