        ...
        <div class="container mx-auto">
            <div class="flex justify-between md:gap-10">
                ...
                <div class="flex items-center justify-center text-slate-800">
                    ...
                    <!-- kategori -->
                    <div class="relative hidden ml-10 lg:block group dark:text-white">
                ...
                <div class="hidden lg:block relative w-1/3">
                    <span class="absolute left-5 top-3.5 dark:text-zinc-500 text-slate-500">
                    ...
                    <form action="{{ route('course.search') }}" class="my-auto">
                ...
                <div class="flex pr-0 my-auto md:pr-5">
                    ...
                    @else
                        ...
                        <!-- button daftar -->
                        <div class="relative hidden mr-2 lg:block">
                    ...
                    <div class="my-auto">
                        ...
                        <label for="dark-toggle">
                            <div class="cursor-pointer rounded-full border border-zinc-500 w-11 h-11 text-center">
                                <div class="text-xl toggle-icon far fa-sun text-slate-800 dark:text-white mt-1.5">
                                </div>
                            </div>
                        </label>
                    </div>
