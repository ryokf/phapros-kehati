...
@section('body')
    ...
    <div class="relative md:ml-72 bg-blueGray-50 dark:bg-[#1b1b36]">
        <!-- hidden switch theme -->
        <div class="hidden">
        ...
        <div class="px-10 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                @foreach ($courses as $course)
                    <x-member-course-card :id="$course->id" :title="$course->title" :category="$course->category->name" :price="$course->price"
